  ...
  Widget build(BuildContext context) {
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        body: FutureBuilder(
          future: promotionController.fetchPromotion(), // Assuming fetchPromotions is a method in PromoController
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Obx(() {
                                      final isInLocalCart =
                                      cartController.isInCart(item.product.id);
