...
class Organic extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<Models>>(
      future: productsController.fetchRiceCakes(4),
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          return Center(child: Text('No rice cakes available'));
        } else {
                        ...
                        children: [
                                  ...
                                  return GestureDetector(
                                    onTap: () {
                                      ...
                                      Get.snackbar(
                                        ...
                                        '${item['name']} has been ${favoriteController
                          ...
                          Center(
                            child: product.image.isNotEmpty
                                ? Image.network(
                              'https://grocery-dev.greendomains.in/storage/images/products/${product
                                  .image}',
                              fit: BoxFit.cover,
