...
import 'forgot_password_otp_controller.dart'; // Corrected import for the controller
import 'package:grocery/widgets/button/button.dart'; // Your custom button widget
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            languagecontroller.forgotpasswordText,
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // IntlPhoneField(
              //   controller: forgotController.mobileNoController,
              ...
              //   onChanged: (phone) {
              //     forgotController.selectedCountryCode.value = phone.countryCode;
              //   },
              // ),
              CustomTextfield(
                controller: forgotController.mobileNoController,
                ...
                onchange: (value) {
                  forgotController.selectedCountryCode.value = '+971'; // Store the UAE country code
                },
              ),
              ...
              SizedBox(
                ...
                child: Button(
                  ...
                  color: Color(0xFFEB1C23),
                  ontap: () {
                    forgotController.startOtpVerification();
                  },
                ),
              ),
              SizedBox(height: 20.h),
              ...
              Obx(() {
                if (forgotController.isOtpVisible.value) {
                  return Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      // OTP input field
                      ...
                      SizedBox(
                        ...
                        child: Button(
                          ...
                          color: Color(0xFFEB1C23),
                          ontap: () {
                            forgotController.verifyOtpAndResetPassword();
                          },
                        ),
                      ),
                    ],
